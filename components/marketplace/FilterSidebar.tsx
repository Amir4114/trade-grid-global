...
export default function FilterSidebar({ searchParams, showVerification = false }: FilterSidebarProps) {
  ...
  return (
    <form className="space-y-5 rounded-lg border border-neutral-200 bg-white p-4 shadow-sm">
