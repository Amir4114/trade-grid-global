...
| Fulfillment             | `verify-order-fulfillment-system.mjs` | Auto-create, lifecycle, mandatory QC, actor rules, RLS, audit, notifications                                            | Complete foundation; requires migrations 017–018                                               | Dispute actor/completion hold, documents, concurrency, Phase B UI/browser |
