...
**Contract:** [ARCHITECTURE_DECISIONS.md](../../architecture/ARCHITECTURE_DECISIONS.md) (**AD-3.2-001** … **AD-3.2-028**).
...
**Next step:** Implementation Plan for `v0.5.0-order-lifecycle` (migration `018+`) — **not started**.
