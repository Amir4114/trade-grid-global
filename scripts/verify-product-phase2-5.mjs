...
try {
  ...
  const supplier = await signUpCompany("trade", "supplier")
  ...
  check(
    "Supplier can insert draft with structured trade fields",
    !insert.error,
  ...
  const buyer = await signUpCompany("buyer-check", "buyer")
