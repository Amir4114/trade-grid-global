...
function SupplierSettingsForm({
  ...
  const [primaryMarket, setPrimaryMarket] = useState(
    company.export_markets?.[0] ?? company.country
  );
  ...
  return (
    <DashboardShell
      role="supplier"
      title="Settings"
      description="Update company profile, export markets, and response preferences."
    >
      <DashboardPanel title="Company Profile">
        ...
        >
          ...
          />
          <Input
            placeholder="Primary export market"
            value={primaryMarket}
